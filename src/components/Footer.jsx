const Footer = () => {
  return (<footer className="border-t flex items-center justify-center p-4 font-semibold">
    <ul className="flex flex-col gap-4 md:flex-row">
      <li>
          <a href="https://github.com/Abdelkrim-Saouchi/Cancer-drug-search" target="_blank" className="flex gap-2 items-center">
      ...
      <li >
        <a href="https://www.facebook.com/profile.php?id=100005904095028" target="_blank" className="flex gap-2 items-center">
            <svg viewBox="0 0 128 128" className="size-6">
      ...
      <li>
        <a href="mailto:krimouv1995@gmail.com"className="flex gap-2 items-center">
